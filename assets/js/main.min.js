  ...
  function (e, t, i) {
        ...
        function o(e) {
          ...
          if (t) {
            ...
            if ((i.indexOf(e) < 0 && i.unshift(e), g(t).is(a))) r.apply(t, i);
              ...
              for (var s = g(t).parents(), n = 0; n < s.length; n += 1)
                g(s[n]).is(a) && r.apply(s[n], i);
          }
        }
        function l(e) {
          ...
          if (a)
            for (d = 0; d < h.length; d += 1) {
              ...
              u.dom7LiveListeners || (u.dom7LiveListeners = {}),
                ...
                u.dom7LiveListeners[c].push({ listener: r, proxyListener: o }),
            ...
            for (d = 0; d < h.length; d += 1) {
              ...
              u.dom7Listeners || (u.dom7Listeners = {}),
                ...
                u.dom7Listeners[f].push({ listener: r, proxyListener: l }),
    ...
    var G = {
      ...
      B = {
        ...
        create: function () {
          L(this, { observer: D(D({}, G), {}, { observers: [] }) });
        },
        on: {
          init: function (e) {
            e.observer.init();
        ...
        if (!i.isTouchEvent || "touchmove" === o.type) {
          ...
          if (!this.allowTouchMove)
            return (
              ...
              void (
                i.isTouched &&
                (k(a, { startX: d, startY: h, currentX: d, currentY: h }),
                (i.touchStartTime = M()))
              )
            );
          ...
          if (
            ...
            if (
              !(
                ...
                Math.sqrt(Math.pow(p, 2) + Math.pow(u, 2)) <
                  this.params.threshold
              )
            ) {
              var c;
              if (void 0 === i.isScrolling)
                ...
                (this.isVertical() && a.currentX === a.startX)
                  ...
                  : p * p + u * u >= 25 &&
                    ((c =
                      (180 * Math.atan2(Math.abs(u), Math.abs(p))) / Math.PI),
    ...
    function X(e) {
      ...
      if (
        ...
        if (s.freeMode) {
          ...
          if (s.freeModeMomentum) {
            if (i.velocities.length > 1) {
              ...
              (t.velocity = v / m),
                ...
                Math.abs(t.velocity) < s.freeModeMinimumVelocity &&
                  (t.velocity = 0),
                (m > 150 || M() - c.time > 300) && (t.velocity = 0);
            } else t.velocity = 0;
            ...
            if (
              ...
              if (
                ...
                var z = Math.abs((r ? -b : b) - t.translate),
          ...
          for (
            var L = 0, $ = t.slidesSizesGrid[0], O = 0;
            O < o.length;
            O += O < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup
          ) {
            var I = O < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
            void 0 !== o[O + I]
              ? h >= o[O] && h < o[O + I] && ((L = O), ($ = o[O + I] - o[O]))
              : h >= o[O] && ((L = O), ($ = o[o.length - 1] - o[o.length - 2]));
          }
          var A = (h - o[L]) / $,
          ...
          if (u > s.longSwipesMs) {
            ...
            "next" === t.swipeDirection &&
              (A >= s.longSwipesRatio ? t.slideTo(L + D) : t.slideTo(L)),
              "prev" === t.swipeDirection &&
                (A > 1 - s.longSwipesRatio ? t.slideTo(L + D) : t.slideTo(L));
          } else {
    ...
    var _ = {
        ...
        update: {
                ...
                if (t.slidesPerColumn > 1) {
                  ...
                  if ("row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                    var D = Math.floor(
                      ...
                      B =
                        0 === D
                          ? t.slidesPerGroup
                          : Math.min(
                              Math.ceil((h - D * M * t.slidesPerGroup) / M),
                              t.slidesPerGroup
                            );
                    (O =
                      (I =
                    ...
                    "column" === t.slidesPerColumnFill
                      ? ((A = L - (I = Math.floor(L / M)) * M),
                        (I > z || (I === z && A === M - 1)) &&
                          (A += 1) >= M &&
                          ((A = 0), (I += 1)))
                      : (I = L - (A = Math.floor(L / P)) * P);
                  $.css(
                  ...
                  if ("auto" === t.slidesPerView) {
                    ...
                    if (
                      ...
                      var Y = parseFloat(N.getPropertyValue("width") || 0),
                        j = parseFloat(N.getPropertyValue("padding-left") || 0),
                        V = parseFloat(
                      ...
                      if (W && "border-box" === W) S = Y + F + R;
                      else {
                        var q = $[0],
                          _ = q.clientWidth;
                        S = Y + j + V + F + R + (q.offsetWidth - _);
                      }
                    } else {
                    ...
                    (S = (s - (t.slidesPerView - 1) * b) / t.slidesPerView),
                      ...
                      d[L] &&
                        (this.isHorizontal()
                          ? (d[L].style.width = S + "px")
                          : (d[L].style.height = S + "px"));
              ...
              if (
                ...
                for (var se = 0; se < p.length; se += 1) {
                  ...
                  t.roundLengths && (ae = Math.floor(ae)),
                    p[se] < this.virtualSize + p[0] && C.push(ae);
                }
                p = C;
              }
              if (!t.centeredSlides) {
                ...
                for (var re = 0; re < p.length; re += 1) {
                  ...
                  t.roundLengths && (ne = Math.floor(ne)),
                    p[re] <= this.virtualSize - s && C.push(ne);
                }
                (p = C),
          ...
          updateProgress: function (e) {
            ...
            0 === s
              ...
              k(this, { progress: a, isBeginning: r, isEnd: n }),
        ...
        slide: {
          slideTo: function (e, t, i, s) {
            ...
            if (o.cssMode) {
              ...
              else c[w ? "scrollLeft" : "scrollTop"] = E;
              return !0;
            }
            return (
              0 === t
        ...
        loop: {
          loopCreate: function () {
            ...
            for (var u = d.length - 1; u >= 0; u -= 1)
              s.prepend(S(d[u].cloneNode(!0)).addClass(i.slideDuplicateClass));
          },
          loopFix: function () {
        ...
        events: {
          attachEvents: function () {
            ...
            (this.onTouchStart = N.bind(this)),
              ...
              t.cssMode && (this.onScroll = V.bind(this)),
            ...
            if (!o.touch && o.pointerEvents)
              ...
              if (o.touch) {
                ...
                s.addEventListener(i.start, this.onTouchStart, d),
                  ...
                  F || (e.addEventListener("touchstart", R), (F = !0));
              }
      ...
      K = (function () {
        function e() {
          ...
          var n = this;
          (n.support = $()),
            (n.device = O({ userAgent: i.userAgent })),
            (n.browser = I()),
            (n.eventsListeners = {}),
    ...
    var ie = {
      ...
      se = {
        ...
        create: function () {
          L(this, { keyboard: te({ enabled: !1 }, ie) });
        },
        on: {
          init: function (e) {
    ...
    var ae = {
      ...
      handle: function (e) {
        ...
        if ((s.invert && (r = -r), i.params.freeMode)) {
          var l = { time: M(), delta: Math.abs(r), direction: Math.sign(r) },
          ...
          if (
            ...
            if (
              (t.dynamicBullets &&
                ...
                (l =
                  ((o = n + (Math.min(d.length, t.dynamicMainBullets) - 1)) +
                    n) /
                  2)),
              d.removeClass(
                t.bulletActiveClass +
              ...
              if ((h.addClass(t.bulletActiveClass), t.dynamicBullets)) {
                for (var u = d.eq(n), c = d.eq(o), f = n; f <= o; f += 1)
      ...
      updateSize: function () {
        if (this.params.scrollbar.el && this.scrollbar.el) {
          ...
          (s =
            ...
            k(e, { trackSize: a, divider: r, moveDivider: n, dragSize: s }),
            e.$el[
              this.params.watchOverflow && this.isLocked
                ? "addClass"
                : "removeClass"
      ...
      init: function () {
        if (this.params.scrollbar.el) {
          ...
          0 === a.length &&
            ...
            s.append(a)),
            k(e, { $el: s, el: s[0], $dragEl: a, dragEl: a[0] }),
      ...
      onGestureStart: function (e) {
        ...
        if (
          ...
          (s.fakeGestureTouched = !0),
            (a.scaleStart = fe.getDistanceBetweenTouches(e));
        }
      ...
      onGestureChange: function (e) {
        ...
        if (!t.gestures) {
          ...
          (s.fakeGestureMoved = !0),
            (a.scaleMove = fe.getDistanceBetweenTouches(e));
        }
      ...
      onTouchMove: function (e) {
        ...
        if (
          ...
          s.isMoved ||
            ...
            (s.startX = P(i.$imageWrapEl[0], "x") || 0),
            (s.startY = P(i.$imageWrapEl[0], "y") || 0),
    ...
    var xe = {
      init: function () {
        ...
        if (this.params.history) {
          ...
          var t = this.history;
          (t.initialized = !0),
            (t.paths = xe.getPathValues(this.params.url)),
      ...
      setHistoryPopState: function () {
        (this.history.paths = xe.getPathValues(this.params.url)),
      ...
      setHistory: function (e, t) {
        ...
        if (this.history.initialized && this.params.history.enabled) {
          ...
          var a = this.slides.eq(t),
            r = xe.slugify(a.attr("data-history"));
      ...
      scrollToSlide: function (e, t, i) {
        if (t)
          for (var s = 0, a = this.slides.length; s < a; s += 1) {
            ...
            if (
              xe.slugify(r.attr("data-history")) === t &&
    ...
    var Ge = {
          ...
          return (
            e.swiper instanceof t
              ? ((this.thumbs.swiper = e.swiper),
                k(this.thumbs.swiper.originalParams, {
      ...
      Be = [
        ...
        },
        {
          ...
          create: function () {
            L(this, { pagination: oe({ dynamicBulletIndex: 0 }, le) });
          },
          on: {
            init: function (e) {
        ...
        },
        {
          ...
          create: function () {
            L(this, { lazy: ve({ initialImageLoaded: !1 }, me) });
          },
          on: {
            beforeInit: function (e) {
        ...
        },
        {
          ...
          create: function () {
            L(this, {
              controller: ge({ control: this.params.controller.control }, ye),
            });
          },
          on: {
            update: function (e) {
        ...
        },
        {
          ...
          create: function () {
            L(this, { hashNavigation: Te({ initialized: !1 }, Se) });
          },
          on: {
            init: function (e) {
        ...
        },
        {
          ...
          create: function () {
            L(this, {
              autoplay: Ce(Ce({}, Me), {}, { running: !1, paused: !1 }),
            });
          },
          on: {
            init: function (e) {
        ...
        },
        {
          ...
          create: function () {
            L(this, { thumbs: De({ swiper: null, initialized: !1 }, Ge) });
          },
          on: {
            beforeInit: function (e) {
    ...
    Z.use(Be),
      document.addEventListener("DOMContentLoaded", function () {
        new Z(".slider-main__slider", {
          ...
          new Z(".similar-products__slider", {
            loop: !0,
            simulateTouch: !1,
            slidesPerView: 4,
            spaceBetween: 10,
        ...
        var e = document.querySelector(".hamburger"),
          t = document.querySelector(".nav-mob"),
        ...
        e.addEventListener("click", function () {
          ...
          document.querySelectorAll(".info-card__amount").forEach(function (e) {
            var t = e.querySelector(".info-card__quantity"),
              i = e.querySelector(".plus"),
              s = e.querySelector(".minus");
            i.addEventListener("click", function (e) {
              e.preventDefault, t.value++;
            }),
              s.addEventListener("click", function (e) {
                e.preventDefault, t.value >= 2 ? t.value-- : (t.value = 1);
              });
          }),
          document.querySelectorAll(".product").forEach(function (e, t) {
            setTimeout(function () {
              e.classList.add("product_visible");
            }, 250 * t);
          });
      });
  },
